  ...
  return (
    <div className="flex h-screen font-sans">
      <div className="w-3/4 bg-gray-100 p-4 overflow-auto">
        <h1 className="text-2xl font-bold mb-4">Kikopey Land Map</h1>
        ...
        <div className="grid grid-cols-12 gap-1">
          {plots.map((plot) => (
            <div
              ...
              className={`h-16 text-xs flex items-center justify-center cursor-pointer text-white rounded ${statusColors[plot.status]}`}
            >
              {plot.id}
            </div>
          ))}
